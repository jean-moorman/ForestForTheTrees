...
async def phase_one_workflow(
    ...
    # Use the existing lazy loading mechanism which handles missing imports gracefully
...
async def test_water_agent_coordination(phase_one_workflow):
    ...
    # Use the existing lazy loading mechanism which already provides a mock
    with patch.object(
