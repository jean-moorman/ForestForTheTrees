...
@pytest.fixture
def health_tracker(event_queue):
    return HealthTracker(event_queue)

@pytest.fixture
def system_monitor(event_queue, memory_monitor, health_tracker):
    return SystemMonitor(event_queue, memory_monitor, health_tracker)
