...
async def test_clarify(coordination_interface, agent_interface_mock):
    ...
    # Verify metrics were NOT recorded for cached responses (correct behavior)
    assert not agent_interface_mock._metrics_manager.record_metric.called
...
async def test_coordinate_with_next_agent(coordination_interface, agent_interface_mock, next_agent_mock):
    ...
    # Verify coordination was performed (MockCoordinator was used)
    assert coordination_interface.coordination_manager is not None
